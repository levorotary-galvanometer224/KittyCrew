...
KittyCrew — это милый локально-ориентированный дом для ваших AI-питомцев и спутников. Вы можете поселить рядом Claude Code, Codex и GitHub Copilot как персонажей с разными характерами, дать каждому своё пространство и набор навыков и проводить с ними время в одном тёплом интерфейсе с кошачьей темой.
...
- Поселите Claude Code, Codex и GitHub Copilot рядом как спутников с разными характерами.
...
- Поддерживаются участники Claude Code, Codex и GitHub Copilot.
...
- Адаптеры provider связывают приложение с CLI Claude Code, Codex и GitHub Copilot.
